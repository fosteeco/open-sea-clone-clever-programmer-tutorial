...
const style = {
  ...
  cardContainer: `rounded-[3rem] w-1/5`,
        ...
        <div className={style.contentWrapper}>
          ...
          <div className={style.cardContainer}>
            <img
              ...
              alt=""
              src="https://openseauserdata.com/files/beanz_launch_image_original_updated.png"
            />
            <div className={style.infoContainer}>
              ...
              <div className={style.author}>
                <div className={style.name}>
                  <a
                    href="https://opensea.io/TeamAzuki?tab=created"
